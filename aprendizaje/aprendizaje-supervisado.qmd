...
Esta distinción entre ajuste y generalización es central. Un modelo puede describir muy bien la muestra de entrenamiento y, sin embargo, producir predicciones deficientes fuera de ella. Por esta razón, la teoría del aprendizaje automático estudia funciones de pérdida, riesgo esperado\index{Riesgo esperado}, riesgo empírico\index{Riesgo empírico}, complejidad de modelos, regularización y validación.
...
::: {.callout-important title="Hipótesis de muestreo" appearance="default" icon="true"}
...
::: {.callout-note title="Riesgo esperado y riesgo empírico" appearance="default" icon="true"}
