...
::: {.callout-note title="Probabilidades posteriores" appearance="default" icon="true"}
...
::: {.callout-note title="Clasificación y calibración" appearance="default" icon="true"}
