...
Las redes neuronales componen transformaciones afines y activaciones no lineales. Su entrenamiento moderno se apoya en retropropagación, optimización estocástica, inicialización controlada y regularización [@rumelhart1986learning; @glorot2010understanding; @he2015delving; @srivastava2014dropout].
...
::: {.callout-important title="Necesidad de no linealidad"}
...
::: {.callout-note title="Retropropagación no es el optimizador"}
...
::: {.callout-note title="Dropout durante entrenamiento y predicción"}
...
::: {.callout-warning title="Alcance del teorema universal"}
