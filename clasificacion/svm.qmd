# Máquinas de vectores de soporte\index{Máquinas de vectores de soporte}, SVM {#sec-svm}

## Introducción {.unnumbered}

Las máquinas de vectores de soporte buscan una frontera con margen\index{Margen} grande y pueden incorporar transformaciones no lineales mediante kernel\index{Kernels}s. Su formulación conecta optimización convexa, regularización y teoría de generalización [@cortes1995support; @vapnik1998statistical].
...
## Clasificación binaria {.unnumbered}
...
## Hiperplano separador {.unnumbered}
...
## Separabilidad lineal {.unnumbered}
...
## Escala del hiperplano {.unnumbered}
...
## Distancia de un punto al hiperplano {.unnumbered}
...
::: {.callout-important title="Escalamiento de la representación" appearance="default" icon="true"}
...
![La SVM lineal busca una frontera con margen máximo y depende de los vectores de soporte.](../estilos/figuras/svm-margen.png){#fig-svm-margen width=84% fig-alt="Dos clases separadas por una recta central y dos márgenes paralelos"}

## Margen geométrico {.unnumbered}
...
## Margen del clasificador {.unnumbered}
...
## Normalización canónica {.unnumbered}
...
## Hiperplanos del margen {.unnumbered}
...
## Problema de margen máximo {.unnumbered}
...
## Vectores de soporte {.unnumbered}
...
## Formulación lagrangiana {.unnumbered}
...
## Condición respecto del vector normal {.unnumbered}
...
## Condición respecto del intercepto {.unnumbered}
...
## Problema dual de margen duro {.unnumbered}
...
## Condiciones de complementariedad {.unnumbered}
...
## Función de decisión dual {.unnumbered}
...
## Datos no separables {.unnumbered}
...
## Variables de holgura {.unnumbered}
...
## Problema de margen suave {.unnumbered}
...
## Interpretación del parámetro C {.unnumbered}
...
## Interpretación como riesgo regularizado {.unnumbered}
...
## Dual del margen suave {.unnumbered}
...
## Interpretación de los multiplicadores {.unnumbered}
...
## Fronteras no lineales {.unnumbered}
...
## Interpretación del parámetro gamma {.unnumbered}
...
## Condición de Mercer {.unnumbered}
...
## Cálculo del intercepto {.unnumbered}
...
## Escalamiento de variables {.unnumbered}
...
## Número de vectores de soporte {.unnumbered}
...
## Uno contra el resto {.unnumbered}
...
Entrada:
  D = {(x_i, y_i)}_{i=1}^n, con y_i ∈ {-1,+1}, C > 0
Salida:
  hiperplano separador \hat f(x)=sign(w^T x + b)

1. Resolver el problema de optimización
      minimizar_{w,b,ξ}   (1/2)||w||^2 + C\sum_{i=1}^n ξ_i
      sujeto a            y_i(w^T x_i + b) ≥ 1 - ξ_i,
                          ξ_i ≥ 0.
2. Obtener la solución (\hat w, \hat b, \hat ξ).
3. Identificar los vectores de soporte:
      i tales que y_i(\hat w^T x_i + \hat b) ≤ 1.
4. Definir la regla de decisión
      \hat y(x)=sign(\hat w^T x + \hat b).
5. En la versión con kernel, reemplazar x_i^T x_j por K(x_i,x_j).
```
:::

## Ventajas de SVM {.unnumbered}
...
## Limitaciones de SVM {.unnumbered}
...
## Maldición de la dimensionalidad {.unnumbered}
...
## Robustez frente a valores atípicos {.unnumbered}
...
## Métodos de optimización {.unnumbered}
...
## SVM lineal para grandes datos {.unnumbered}
...
## Interpretación del margen como confianza {.unnumbered}
...
## Ejemplo de hiperplano {.unnumbered}
...
## Ejemplo de pérdida hinge {.unnumbered}
...
## Ejercicio de distancia al hiperplano {.unnumbered}
...
## Ejercicio de margen {.unnumbered}
...
## Ejercicio de pérdida hinge {.unnumbered}
...
## Ejercicio de kernel radial {.unnumbered}
...
## Ejercicio de selección {.unnumbered}
...
Los fundamentos se apoyan en @cortes1995support, @vapnik1998statistical, @bishop2006pattern y @hastie2009elements.
